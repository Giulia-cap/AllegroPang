...
Player::Player(int l,Type t):DynamicObject(l,t)
{
	...
	/*image=al_load_bitmap("./resources/player/.dx1.png");
	imagedx.push_back(image);
	image=al_load_bitmap("./resources/player/dx2.png");
	imagedx.push_back(image);  */
	image=al_load_bitmap("./resources/player/player.bmp");
